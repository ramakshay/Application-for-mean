...
router.post("/login", async (req,res) => {
    ...
    //Create token
    const accessToken = jwt.sign({_id : user._id,firstName: user.firstName}, process.env.SECRET_TOKEN1,{expiresIn:'1h'});
    const refreshToken = jwt.sign({_id : user._id,firstName: user.firstName}, process.env.SECRET_TOKEN2,{expiresIn:'1h'})
